...
Keyboard Inputs::VirtualKeyToKey(UINT _VirtualKey)
{
...
int Inputs::KeyToVirtualKey(Keyboard _Key)
{
	switch (_Key)
	{
...
WORD Inputs::ScanCodeToWinScan(ScanCode _ScanCode)
{
	switch (_ScanCode)
	{
...
WORD Inputs::ScanCodeToWinScanExtended(ScanCode _ScanCode)
{
	switch (_ScanCode)
	{
...
UINT Inputs::ScanCodeToVirtualKey(ScanCode _ScanCode)
{
...
std::optional<std::string> Inputs::ScanCodeToConsumerKeyName(ScanCode _ScanCode)
{
	switch (_ScanCode)
	{
...
Keyboard Inputs::GetKey(ScanCode _ScaneCode)
{
...
ScanCode Inputs::GetScanCode(Keyboard _Key)
{
	if (!IsValidKey(_Key))
	{
...
std::string Inputs::GetDescription(ScanCode _ScanCode)
{
...
void Inputs::SetVirtualKeyboardVisible(bool _Visible)
{
