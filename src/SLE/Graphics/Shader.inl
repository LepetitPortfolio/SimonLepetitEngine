...
template<typename T>
void Shader::DefaultPipelineConfigInfo(PipelineConfigInfo& _ConfigInfo)
{
	...
	if (static_cast<IVulkanDescription*>(T{}))
	{
		_ConfigInfo.BindingDescriptions = T::GetBindingDescriptions();
